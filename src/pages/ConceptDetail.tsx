...
export function ConceptDetail() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-8 md:py-16 max-w-3xl">
      ...
      <div className="mb-4">
        <InstagramEmbed url={concept.reelUrl} caption={`Reel for ${concept.title} — coming soon.`} />
      </div>
      <p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground/70 text-center mb-10">
        Watched the reel? The longer version is below.
      </p>
      ...
      <Accordion>
        {notebookSections.map((title, i) => (
          ...
          >
            <p>
              Placeholder for <em>{title}</em>. A short paragraph or two goes here — the lab-note
              version for people who want more than the 30-second reel, not a textbook chapter.
            </p>
          </AccordionItem>
        ))}
      </Accordion>
